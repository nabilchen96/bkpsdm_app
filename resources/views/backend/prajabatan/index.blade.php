...
@section('content')
        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-12 col-xl-8 mb-xl-0">
                    <h3 class="font-weight-bold">Data Prajabatan</h3>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                <form id="form">
                    <div class="modal-header p-3">
                        <h5 class="modal-title m-2" id="exampleModalLabel">Ujian Dinas Form</h5>
                    </div>
    ...
    <div class="modal fade" id="modal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="form2" method="post" action="{{ url('export-prajabatan') }}">
                    @csrf
                    <div class="modal-header p-3">
...
@push('script')
    ...
    <script>
        ...
        form.onsubmit = (e) => {
            ...
            axios({
                    method: 'post',
                    url: formData.get('id') == '' ? '{{ url('store-prajabatan') }}' :
                        '{{ url('update-prajabatan') }}',
                    data: formData,
                })
                .then(function(res) {
                    //handle success         
        ...
        hapusData = (id) => {
            Swal.fire({
                ...
                if (result.value) {
                    axios.post('{{ url('delete-prajabatan') }}', {
                            id
                        })
                        .then((response) => {
